            ...
            <atlas-panel header="Criar Cobrança">
                <atlas-form action="${createLink(controller: "payment", action: "save")}" method="post">
                    <atlas-layout row gap="4">
                        <atlas-select label="Selecione o pagador" name="payerId" value="${params.payerId}"
                                      required="true">
                        ...
                        <atlas-select label="Insira a forma de pagamento" name="billingType" value="${params.payerId}"
                                      required="true">
                            <atlasFormTagLib:optionList
                                    name="billingType"
